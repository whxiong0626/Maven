...
<head>
    <link rel="stylesheet" href="static/css/public.css" type="text/css"></link>
</head>
<body>
<div id="div">
    <table border="2">
...
<ul><li><div  class="pagination" id="pagination"></div></li></ul>
